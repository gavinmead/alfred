...
go_repository(
    name = "com_github_aaaton_golem_v4",
    importpath = "github.com/aaaton/golem/v4",
    sum = "h1:jvnnTmzdfZC8cUGIo6obIcnmB3stTaf5Uw64OMx3C84=",
    version = "v4.0.1",
)

go_repository(
    name = "com_github_aaaton_golem_v4_dicts_en",
    importpath = "github.com/aaaton/golem/v4/dicts/en",
    sum = "h1:/BsOsh8JTgTkuevwM9axPnAi9CD4rK7TWHNdW/6V3Uo=",
    version = "v1.0.1",
)
